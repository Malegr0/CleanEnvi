...
public final class ProductMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Einträge der Datenbank (Name und Recyclingnummer)
        ...
        searchproductbtn.setOnClickListener(new OnClickListener() {
            public final void onClick(View it) {
                ProductMainActivity.this.startActivity(new Intent(ProductMainActivity.this, ProductSearchActivity.class));
            }
        });

        databasebtn.setOnClickListener(new OnClickListener() {
            public final void onClick(View it) {
                ProductMainActivity.this.startActivity(new Intent(ProductMainActivity.this, DataMainActivity.class));
            }
        });
        ...
        codeScannerbtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ProductMainActivity.this.startActivity(new Intent(ProductMainActivity.this, CameraMainActivity.class).addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION));
            }
        });
    }
